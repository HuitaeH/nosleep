...
class ConcentrationGraph:
    ...
    def _init_plot_data(self):
        ...
        self.C_vals = [100] * self.max_frames  # ‚≠êÔ∏è Ï¥àÍ∏∞ concentration 100?úºÎ°? ?Ñ§?†ï
    ...
    def _update_plot(self, value):
        ...
        # Concentration Í∞íÏùÑ 0~1Î°? ?†ïÍ∑úÌôî?ï¥?Ñú Ï∂îÍ??
